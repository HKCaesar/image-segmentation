...
is_training_placeholder = model_input(with_input_placeholder=True)
...
model = Model(batch_images, number_of_classes=number_of_classes,
                                  is_training=is_training_placeholder, model_name="FCN")
...
with tf.Session() as sess:
    ...
    for images_batch_np, annotation_batch_np in next_batch(training_images_dir, training_labels_dir, images_filenale_list, random_crop=False):

        # pred_np, probabilities_np, _, _ = sess.run([pred, probabilities, miou_update_op, acc_update_op],
        #                                            feed_dict={input_image_placeholder: images_batch_np,
        #                                                       input_annotation_placeholder: annotation_batch_np,
